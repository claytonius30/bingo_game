...
$(function () {
  ...
  if (window.location.href.indexOf('host.html') > -1 || window.location.href.indexOf('.html') === -1) {
    ...
    $('#startgame').on('click', function () {
      ...
      if (hostNameInput !== "") {
        ...
        // $.post('http://bingo.consulogic.org/host/start-game', { hostName: hostNameInput }, function (data) {
  ...
  // This block handles the dynamically loaded host draw page
    ...
    $('#drawnumber').on('click', function () {
      // $.get(`http://bingo.consulogic.org/host/draw-number?hostName=${hostName}&gameId=${gameId}`, function(data) {
    ...
    $('#resetgame').on('click', function () {
      ...
      $('#drawnspace').empty();
      count = 1;
      // $.get(`http://bingo.consulogic.org/host/retart-game?hostName=${hostName}&gameId=${gameId}`, function(data) {
      ...
      socket2.onclose = function (event) {
        ...
        socket.onclose = function (event) {
          ...
          socket3.onclose = function (event) {
            // $.get(`http://bingo.consulogic.org/host/stop-game?hostName=${hostName}&gameId=${gameId}`, function(data) {
    ...
    $("#playersLink").on("click", function(event) {
      ...
      // $.get(`http://bingo.consulogic.org/host/players?hostName=${hostName}&gameId=${gameId}`, function(data) {
